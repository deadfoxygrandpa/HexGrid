...
port inGridRect = \n -> discard (HexGrid.inGrid (HexGrid.hexCoord 10 10) grid1, n)

port inGridHex : Int -> Int
port inGridHex = \n -> discard (HexGrid.inGrid (HexGrid.hexCoord 10 10) grid2, n)

port rectangularHexGrid : Int -> Int
port rectangularHexGrid = \n -> discard (HexGrid.rectangularHexGrid 44 0, n)

port hexagonalHexGrid : Int -> Int
port hexagonalHexGrid = \n -> discard (HexGrid.hexagonalHexGrid 25 0, n)

port showHexGridRect : Int -> Int
port showHexGridRect = \n -> discard (HexGrid.showHexGrid 25 styler grid1, n)

port showHexGridHex : Int -> Int
port showHexGridHex = \n -> discard (HexGrid.showHexGrid 25 styler grid2, n)

port pixelToHexCoord : Int -> Int
port pixelToHexCoord = \n -> discard (HexGrid.pixelToHexCoord 25 (50, 50), n)

port neighbors : Int -> Int
port neighbors = \n -> discard (HexGrid.neighbors (HexGrid.hexCoord 0 0), n)

port diagonals : Int -> Int
port diagonals = \n -> discard (HexGrid.diagonals (HexGrid.hexCoord 0 0), n)

port distance : Int -> Int
port distance = \n -> discard (HexGrid.distance (HexGrid.hexCoord 10 19) (HexGrid.hexCoord 0 0), n)

port range1 : Int -> Int
port range1 = \n -> discard (HexGrid.range (HexGrid.hexCoord 0 0) 1, n)

port range10 : Int -> Int
port range10 = \n -> discard (HexGrid.range (HexGrid.hexCoord 0 0) 10, n)

port ring1 : Int -> Int
port ring1 = \n -> discard (HexGrid.ring (HexGrid.hexCoord 0 0) 1, n)

port ring10 : Int -> Int
port ring10 = \n -> discard (HexGrid.ring (HexGrid.hexCoord 0 0) 10, n)

port insert : Int -> Int
port insert = \n -> discard (HexGrid.insert (HexGrid.hexCoord 0 0) 1 grid1, n)

port insertIfPossible : Int -> Int
port insertIfPossible = \n -> discard (HexGrid.insertIfPossible (HexGrid.hexCoord 0 0) 1 grid1, n)
